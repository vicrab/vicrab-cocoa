...
// files, arranged for use in VicrabCrashObjC.

#ifndef HDR_VicrabCrashObjCApple_h
#define HDR_VicrabCrashObjCApple_h
...
// VicrabCrash: The original values wouldn't have worked. The slot shift and mask
// were incorrect.
#define TAG_COUNT 8
...
#endif // HDR_VicrabCrashObjCApple_h
