...
/**
 * Initializes a VicrabClient which can be used for sending events to vicrab.
 *
 * @param dsn DSN string of vicrab
 * @param requestManager Object conforming VicrabRequestManager protocol
...
- (void)setUp {
    ...
    self.client = [[VicrabClient alloc] initWithDsn:dsn
...
- (void)testRealRequest {
    ...
    VicrabClient *client = [[VicrabClient alloc] initWithDsn:dsn
...
- (void)testRequestQueueCancel {
    ...
    VicrabQueueableRequestManager *requestManager = [[VicrabQueueableRequestManager alloc] initWithSession:[VicrabMockNSURLSession new]];
    VicrabClient *client = [[VicrabClient alloc] initWithDsn:@"http://a:b@vicrab.io/1"
                                              requestManager:requestManager
                                            didFailWithError:nil];
