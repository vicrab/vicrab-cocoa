//
//  VicrabCrashReportFixer_Tests.m
//  VicrabCrash-iOS
//
...
#import "VicrabCrashReportFixer.h"

@interface VicrabCrashReportFixer_Tests : XCTestCase

@end

@implementation VicrabCrashReportFixer_Tests
...
- (void)testLoadCrash
{
    ...
    char* fixedBytes = vicrabcrashcrf_fixupCrashReport(rawData.bytes);
